...
public class StreamExecutionEnvironment {
    ...
    public JobExecutionResult execute() throws Exception {
        return execute(DEFAULT_JOB_NAME).getJobExecutionResult();
    }
     ...
     * @throws Exception which occurs during job execution.
     */
    public JobExecutionResultWithClient execute(String jobName) throws Exception {
     ...
     * for example printing results or forwarding them to a message queue.
     *
     * @param streamGraph graph created from translated job transforms
     * @return The result of the job execution, containing elapsed time and accumulators.
     * @throws Exception which occurs during job execution.
     */
    @Internal
    public JobExecutionResultWithClient execute(StreamGraph streamGraph) throws Exception {
        ...
        try {
            ...
            return new JobExecutionResultWithClient(jobExecutionResult, jobClient);
        } catch (Throwable t) {
