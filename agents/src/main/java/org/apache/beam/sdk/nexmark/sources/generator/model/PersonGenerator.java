...
public class PersonGenerator {
    // TODO it used to be 10
    /** Number of yet-to-be-created people and auction ids allowed. */
    private static final int PERSON_ID_LEAD = 0;
    ...
    public static Person nextPerson(
        ...
        long id = lastBase0PersonId(nextEventId, config) + GeneratorConfig.FIRST_PERSON_ID;
     ...
     */
    public static long lastBase0PersonId(long eventId, GeneratorConfig config) {
        ...
        /*if (eventId >= 2 * 2500 * 10 && eventId < 3 * 2500 * 10) {
            LOG.info("person id epoch " + epoch + " offset " + offset);
        }*/
