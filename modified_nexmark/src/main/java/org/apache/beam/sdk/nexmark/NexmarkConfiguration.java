...
public class NexmarkConfiguration implements Serializable {
   ...
   */
  @JsonProperty public long numEvents = 1000000; // DEFAULT 1000000
  ...
  @JsonProperty public int firstEventRate = 50000; // DEFAULT 10000

  /** Next overall event rate (in {@link #rateUnit}). */
  @JsonProperty public int nextEventRate = 50000; // DEFAULT 10000
  ...
  @JsonProperty public int avgPersonByteSize = 200; // DEFAULT 200
  ...
  @JsonProperty public long windowSizeSec = 10; // DEFAULT 10
