...
public class NexmarkQueryUtil {
	...
	public static final SerializableFunction<Event, Boolean> IS_NEW_PERSON = event -> event.newPerson != null;

	/** DoFn to convert a new person event to a person. */
	public static final DoFn<Event, Person> AS_PERSON = new DoFn<Event, Person>() {
		@ProcessElement
	...
	public static final SerializableFunction<Event, Boolean> IS_NEW_AUCTION = event -> event.newAuction != null;

	/** DoFn to convert a new auction event to an auction. */
	public static final DoFn<Event, Auction> AS_AUCTION = new DoFn<Event, Auction>() {
		@ProcessElement
		public void processElement(ProcessContext c) {
	...
	public static final DoFn<Event, Bid> AS_BID = new DoFn<Event, Bid>() {
		@ProcessElement
		public void processElement(ProcessContext c) {
	...
	public static final ParDo.SingleOutput<Person, KV<Long, Person>> PERSON_BY_ID = ParDo
	...
	public static final ParDo.SingleOutput<Auction, KV<Long, Auction>> AUCTION_BY_ID = ParDo
	...
	public static final ParDo.SingleOutput<Auction, KV<Long, Auction>> AUCTION_BY_SELLER = ParDo
			.of(new DoFn<Auction, KV<Long, Auction>>() {
				@ProcessElement
				public void processElement(ProcessContext c) {
	...
	public static final ParDo.SingleOutput<Bid, KV<Long, Bid>> BID_BY_AUCTION = ParDo
	...
	public static final ParDo.SingleOutput<Bid, Long> BID_TO_AUCTION = ParDo.of(new DoFn<Bid, Long>() {
		@ProcessElement
		public void processElement(ProcessContext c) {
	...
	public static final ParDo.SingleOutput<Bid, Long> BID_TO_PRICE = ParDo.of(new DoFn<Bid, Long>() {
		@ProcessElement
		public void processElement(ProcessContext c) {
	...
	public static final ParDo.SingleOutput<Event, Event> EVENT_TIMESTAMP_FROM_DATA = ParDo.of(new DoFn<Event, Event>() {
		@ProcessElement
		public void processElement(ProcessContext c) {
			Event e = c.element();
			if (e.bid != null) {
	...
	public static final PTransform<PCollection<Event>, PCollection<Auction>> JUST_NEW_AUCTIONS = new PTransform<PCollection<Event>, PCollection<Auction>>(
			"justNewAuctions") {
		@Override
	...
	public static final PTransform<PCollection<Event>, PCollection<Person>> JUST_NEW_PERSONS = new PTransform<PCollection<Event>, PCollection<Person>>(
			"justNewPersons") {
		@Override
	...
	public static final PTransform<PCollection<Event>, PCollection<Bid>> JUST_BIDS = new PTransform<PCollection<Event>, PCollection<Bid>>(
			"justBids") {
		@Override
	...
	/** Transform to filter for just the bid events. */
	public static final PTransform<PCollection<Event>, PCollection<PageView>> JUST_VIEWS = new PTransform<PCollection<Event>, PCollection<PageView>>(
			"justPageViews") {
		@Override
		public PCollection<PageView> expand(PCollection<Event> input) {
			return input.apply("IsPageView", Filter.by(IS_PAGEVIEW)).apply("AsPageView", ParDo.of(AS_PAGEVIEW));
		}
	};

	/** Predicate to detect a new bid event. */
	public static final SerializableFunction<Event, Boolean> IS_PAGEVIEW = event -> event.pageView != null;

	/** DoFn to convert a bid event to a bid. */
	public static final DoFn<Event, PageView> AS_PAGEVIEW = new DoFn<Event,PageView>() {
		@ProcessElement
		public void processElement(ProcessContext c) {
			c.output(c.element().pageView);
		}
	};
