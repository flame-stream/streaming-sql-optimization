package org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.plan.volcano;

import org.apache.beam.vendor.calcite.v1_20_0.com.google.common.collect.*;
import org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.avatica.util.Spaces;
import org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.config.CalciteConnectionConfig;
import org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.config.CalciteSystemProperty;
...
import org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.rel.RelVisitor;
import org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.rel.convert.Converter;
import org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.rel.convert.ConverterRule;
import org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.rel.externalize.RelWriterImpl;
...
import org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.sql.SqlExplainLevel;
...
import org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.util.PartiallyOrderedSet;
...
public class VolcanoPlanner extends AbstractRelOptPlanner {
    public static final Logger LOG = LoggerFactory.getLogger("planner");
    ...
    /** Zero cost, according to {@link #costFactory}.*/
    ...
    public VolcanoPlanner(RelOptCostFactory costFactory, //
        ...
        this.provenanceMap = LOG.isDebugEnabled() ? new HashMap<>()
                : Util.blackholeMap();
    }
     ...
     * {@link org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.plan.RelOptPlanner#setRoot(org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.rel.RelNode)}.
     *
    ...
    public RelNode findBestExp() {
        ...
        for (VolcanoPlannerPhase phase : VolcanoPlannerPhase.values()) {
            ...
            while (true) {
                ...
                LOG.info("PLANNER = {}; TICK = {}/{}; PHASE = {}; COST = {}",
    ...
    void ensureRootConverters() {
        ...
        for (RelSubset subset : root.set.subsets) {
            final org.apache.beam.vendor.calcite.v1_20_0.com.google.common.collect.ImmutableList<RelTrait> difference =
    ...
    /**
     * Helper for {@link #provenance(org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.rel.RelNode)}.
     */
    ...
    public RelOptCost getCost(RelNode rel, RelMetadataQuery mq) {
        ...
        if (rel instanceof RelSubset) {
            RelOptCost res = ((RelSubset) rel).bestCost;
            LOG.info("best " + res);
            return res;
        }
        ...
        LOG.info(rel.getRelTypeName() + " cost " + cost);
        if (!zeroCost.isLt(cost)) {
            // cost must be positive, so nudge it
            cost = costFactory.makeTinyCost();
        }
        for (RelNode input : rel.getInputs()) {
            final RelOptCost inputCost = getCost(input, mq);
            LOG.info("input " + input + " cost " + inputCost);
...
//            if (fromTrait.subsumes(toTrait)) {
    ...
    void rename(RelNode rel) {
        ...
        if (fixUpInputs(rel)) {
            ...
            LOG.trace("Rename #{} from '{}' to '{}'", rel.getId(), oldDigest, newDigest);
            ...
            if (equivRel != null) {
                ...
                LOG.trace("After renaming rel#{} it is now equivalent to rel#{}",
    ...
    private RelSubset registerImpl(
        ...
        LOG.trace("Register {} in {}", rel.getDescription(), subset.getDescription());
    ...
    private RelSubset registerSubset(
        ...
        if ((set != subset.set)
                && (set != null)
                && (set.equivalentSet == null)) {
            LOG.trace("Register #{} {}, and merge sets", subset.getId(), subset);
     ...
     * new rules. {@link #addRule(org.apache.beam.vendor.calcite.v1_20_0.org.apache.calcite.plan.RelOptRule)} will do
