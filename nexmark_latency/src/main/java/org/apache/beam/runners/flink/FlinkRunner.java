...
/**
 * A copy of original FlinkRunner for print Flink graph to log.
 */
@SuppressWarnings({
...
public class FlinkRunner extends PipelineRunner<PipelineResult> {
    ...
    public PipelineResult run(Pipeline pipeline) {
        ...
        String executionPlanJSON =  env.getStreamExecutionEnvironment().getExecutionPlan();
        LOG.info("\n\n\n\n\n ---> Result of the translation:");
        LOG.info(executionPlanJSON + "\n\n\n\n\n");
